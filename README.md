Рекомендации по разработке компонент с использованием React и Redux

0. Определения и комментарии:

    0.1. обозначения в кратких схемах:
    ...
    0.2. в данном описании для удобства введены некоторые определения, не встречающиеся в известной документации по React и Redux. Это сделано с целью выделения в отдельные сущности ключевых нюансов, не критичных для самой технологии, но важных в контексте приведённых здесь рекомендаций по её использованию.
